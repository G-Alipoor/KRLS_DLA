...
%
% KRLSTest    Function used to test the Kernel RLS-DLA over USPS and ISOLET datasets
%
...
%         DataSet:                 Dataset; a string. Options are 'USPS' (Default) and 'ISOLET'
...
%         GrowingCriterion:    The growing criterion used to check the informativeness of the new sample;
%                                           a string. Options are 'Coherency', 'Representation'(Default) and 'Projection'
%         GrowingTrsh:           The growing treshold; a scalar number smaller than or equal to 1 (Default: 0.95)
